...
/**
 * Foreground service that keeps the app process alive while recording.
 * Without this, Android kills the network when the app is backgrounded.
 *
 * Start: RecordingService.start(context, "emmiep")
 * Stop:  RecordingService.stop(context)
 */
class RecordingService : Service() {
    ...
    private fun buildNotification(streamerName: String): Notification =
        NotificationCompat.Builder(this, CHANNEL_ID)
            .setSmallIcon(R.drawable.article_24px)
    ...
    private fun createChannel() {
        ...
        ).apply { description = "Shown while a stream is being recorded" }
