 ...
 *
 * Android 10+ blocks direct writes to arbitrary external paths via File API unless
 * MANAGE_EXTERNAL_STORAGE is granted. This function just resolves the display path; actual write
 * permission is handled via that permission.
 */
