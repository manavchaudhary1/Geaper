...
data class Streamer(
  ...
  /**
   * yt-dlp -f format selector stored per-streamer. Empty string → use app default
   * (bestvideo+bestaudio/best). Examples: "bestvideo[height<=720]+bestaudio/best[height<=720]"
   */
